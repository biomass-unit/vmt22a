...
DECLARE_FORMATTER_FOR(ast::definition::Implementation);
DECLARE_FORMATTER_FOR(ast::definition::Implementation_template);
...
DECLARE_FORMATTER_FOR(ast::definition::Typeclass_template);
